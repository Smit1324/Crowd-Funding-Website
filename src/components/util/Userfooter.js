                    ...
                    <div className='d-flex mb-4 f0'>
                        ...
                        <div className='d-flex mt-4 f1'>
                            ...
                            <div className="mb-3 mx-5">
                                ...
                                <ul className="nav flex-column mt-3">
                                    <li className="nav-item mb-2">
                                        <NavLink className="nav-link foot-link p-0 text-muted" to={`/${id}`}>Invest</NavLink >
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="mb-3 mx-5">
                                ...
                                <ul className="nav flex-column mt-3">
                                    <li className="nav-item mb-2">
                                        <NavLink className="nav-link foot-link p-0 text-muted" to={`/userraise/${id}`}>Raise</NavLink >
                                    </li>
                                </ul>
                            </div>
